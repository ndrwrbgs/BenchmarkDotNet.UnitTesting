...
namespace LibraryV3
{
    ...
    public sealed class LatencyValidatorBuilder
    {
        ...
        public LatencyValidatorBuilder IfFasterThan(double withConfidenceLevel, LatencyValidatorBehavior then)
        {
        ...
        public LatencyValidatorBuilder IfSlowerThan(double withConfidenceLevel, LatencyValidatorBehavior then)
        {
            return new LatencyValidatorBuilder(
                this.steps
